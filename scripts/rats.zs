...
recipes.addShaped("rats_herb_bundle", <rats:herb_bundle> * 3, [[<ore:sweetHerb>, <ore:sweetHerb>, <ore:sweetHerb>], [<ore:sweetHerb>, <rats:assorted_vegetables>, <ore:sweetHerb>], [<ore:sweetHerb>, <ore:sweetHerb>, <ore:sweetHerb>]]);
